...
if __name__ == "__main__":
    ...
    for fun in funs:
        ...
        with open(qmdfile, "w+") as fid:
            print(man, file = fid)
        man_func_created[fun[0]] = f"{args.man_dir}/{os.path.basename(qmdfile)}"
    ...
    for cls in clss:
        ...
        with open(qmdfile, "w+") as fid:
            print(man, file = fid)
        man_class_created[cls[0]] = f"{args.man_dir}/{os.path.basename(qmdfile)}"
